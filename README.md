...
run_topsis('data.csv', '1,1,1,1,1', '+,+,-,+,+', 'output.csv')
```
...
- topsis_calc.py - Core TOPSIS algorithm
...
```bash
pip install Topsis-Naman-102317144
topsis data.csv "1,1,1,1,1" "+,+,-,+,+" test_output2.csv
```
...
- Topsis-Naman-102317144 folder containing __init__.py, __main__.py, topsis_calc.py
- setup.py
- setup.cfg
- MANIFEST.in
